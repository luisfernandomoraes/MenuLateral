...
extern void *mono_aot_module_MenuLateral_iOS_info;
...
extern void *mono_aot_module_MenuLateral_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;

void xamarin_register_modules ()
{
	mono_aot_register_module (mono_aot_module_MenuLateral_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_MenuLateral_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "MenuLateral.iOS.exe";
